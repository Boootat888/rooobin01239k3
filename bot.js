...
client.on('ready', () => {
    client.user.setGame(' ﾠ.شارب كولا ومشبك حولا  ','https://www.twitch.tv/v5bz');
...
if (message.author.id !== "450546449239900160") return;
...
client.login('NDUwNTQ2NDQ5MjM5OTAwMTYw.DmSFLA.FStFpaw_FJ3BsGyA_JlUstO__do');
